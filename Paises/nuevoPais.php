            ...
            <div class="panel-body">    
                <form class="form-horizontal" role="form"  id="fpaises">
 					<div class="form-group">
                        <label class="control-label col-sm-1" for="country_id">Codigo:</label>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-1" for="country">Nombre:</label>
                        <div class="input-group col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-1" for="last_update">Actualizacion: </label>
                        <div class="col-sm-10">
