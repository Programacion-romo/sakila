                ...
                <form class="form-horizontal" role="form"  id="fcategorias">
                     ...
                     <label class="control-label col-sm-2" for="category_id">Codigo:</label>
                        <div class="col-sm-10">
                            ...
                            <input type="text" class="form-control" id="category_id" name="category_id" placeholder="Ingrese Idioma"
                    ...
                    <div class="form-group">        
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="button" id="grabar" class="btn btn-primary" data-toggle="tooltip" title="Grabar Comuna">Grabar categoria</button>
