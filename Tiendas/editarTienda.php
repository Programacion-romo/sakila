                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <option value="" selected>Seleccione ...</option>
								<?php foreach($listaStaff2 as $fila){ ?>
                    ...
                    <div class="form-group">
					 ...
					 <div class="form-group">        
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="button" id="actualizar" class="btn btn-primary" data-toggle="tooltip" title="Actualizar Tienda">Actualizar Tienda</button>
