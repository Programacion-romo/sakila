...
function tiendas(){
    $("#contenido").on("click","button#actualizar",function(){
         ...
         $.ajax({
            type:"get",
            url:"./php/tiendas/controladorTiendas.php",
            data: datos,
            dataType:"json"
              ...
              if(resultado.respuesta){
                ...
                $("#tiendas").removeClass("hide");
                $("#tiendas").addClass("show")
             } else {
                swal({
                  type: 'error',
                  title: 'Oops...',
   ...
   $("#contenido").on("click","button#nuevo",function(){
        ...
        $("#nuevo-editar" ).load("./php/tiendas/nuevaTienda.php"); 
        $("#nuevo-editar").removeClass("hide");
        $("#nuevo-editar").addClass("show");
        $("#tiendas").removeClass("show");
        $("#tiendas").addClass("hide");
         $.ajax({
             type:"get",
             url:"./php/paises/controladorPaises.php",
             data: {accion:'listar'},
...
$(document).ready(() => {
  ...
  dt = $("#tabla").DataTable({
        "ajax": "php/tiendas/controladorTiendas.php?accion=listar",
        "columns": [
            { "data": "store_id"},
            { "data": "first_name"},
            { "data": "last_name"},
